...
# One-hot encoding
X_one_hot = tf.one_hot(X, number_of_class)
...
softmax_w = tf.get_variable("softmax_w", [hidden_size, number_of_class])
softmax_b = tf.get_variable("softmax_b", [number_of_class])
outputs = tf.matmul(X_for_softmax, softmax_w) + softmax_b

# reshape out for sequence_loss
outputs = tf.reshape(outputs, [batch_size, seq_length, number_of_class])
